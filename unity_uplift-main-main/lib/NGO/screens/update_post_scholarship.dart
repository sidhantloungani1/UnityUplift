...
import "package:unity_uplift/NGO/models/scholarshipList_model.dart";
...
class Updatepostscholarship extends StatefulWidget {
  final ScholarshipListModel scholarship_model;
  final String id;
  const Updatepostscholarship(
      {super.key, required this.scholarship_model, required this.id});

  @override
  State<Updatepostscholarship> createState() => _UpdatepostscholarshipState();
}

class _UpdatepostscholarshipState extends State<Updatepostscholarship> {
  ...
  @override
  void initState() {
    selectedScholarship = widget.scholarship_model.scholarshipType;
    valueChoose = widget.scholarship_model.educationLevel;
    _scholarshipTitle.text = widget.scholarship_model.scholarshipTitle;
    _NGOName.text = widget.scholarship_model.NGOName;
    _eligibilityCriteria.text = widget.scholarship_model.eligibilityCriteria;
    _scholarshipDescription.text =
        widget.scholarship_model.scholarshipDescription;
    selectedDate = widget.scholarship_model.expirydate.toDate();
    super.initState();
  }

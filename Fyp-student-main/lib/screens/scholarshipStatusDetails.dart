...
class scholarshipStatusDetails extends StatefulWidget {
  ScholarshipModel s;
  scholarshipStatusDetails({super.key, required this.s});
  ...
  @override
  State<scholarshipStatusDetails> createState() =>
      _scholarshipStatusDetailsState();
}

class _scholarshipStatusDetailsState extends State<scholarshipStatusDetails> {
  @override
  void initState() {}
  @override
              ...
              child: Column(
                ...
                children: [
                  ...
                  ScholarshipDetailSection(
                    ...
                    value: widget.s.scholarship,
                  ),
                  ScholarshipDetailSection(
                    label: 'About',
                    value: widget.s.about,
                  ),
                  ScholarshipDetailSection(
                    label: 'Status of application',
                    value: widget.s.status,
                  ),
                  ScholarshipDetailSection(
                    label: 'Description',
                    value: widget.s.Description,
                  ),
                  ScholarshipDetailSection(

...
class Allngos extends StatefulWidget {
  const Allngos({Key? key}) : super(key: key);

  @override
  State<Allngos> createState() => _AllPendingSellersScreenState();
}

class _AllPendingSellersScreenState extends State<Allngos> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance
        .collection("NGO")
        //    .where("status", isEqualTo: "not allowed")
        .get()
  ...
  Widget build(BuildContext context) {
                  ...
                  Padding(
                    ...
                    child: ListTile(
                      leading: CircleAvatar(
                        ...
                        child: Text(
                          allSellers!.docs[i].get("organizationName")[0],
                          style: const TextStyle(
                              color: Color.fromARGB(255, 0, 0, 0)),
                        ),
                      ),
                      title: Text(
                        allSellers!.docs[i].get("organizationName"),
                        style: const TextStyle(
                          fontSize: 18,
                          color: Colors.white,
                          fontWeight: FontWeight.bold,
    ...
    return Scaffold(
      appBar: SimpleAppBar(
        title: "All Pending Requests for Sellers Accounts ",
      ),
      body: Center(
        child: Container(
